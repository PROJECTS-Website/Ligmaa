...
const BottomNav = () => {
  return (
    <nav className="fixed bottom-0 left-0 right-0 bg-black/30 border-t border-zinc-700/50 shadow-t-lg z-50 md:hidden backdrop-blur-md w-[95%] mx-auto rounded-full">
